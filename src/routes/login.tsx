...
export const Route = createFileRoute("/login")({
  head: () => ({ meta: [{ title: "Entrar — Escola Rosazul" }] }),
  component: LoginPage,
});
    ...
    <div className="min-h-screen grid lg:grid-cols-2 bg-background">
      <div className="hidden lg:flex flex-col justify-between p-12 bg-gradient-to-br from-primary to-primary/70 text-primary-foreground">
        <div className="flex items-center gap-3">
          <img src={logo.url} alt="Escola Rosazul" className="size-14 rounded-xl bg-white p-1" />
          <div>
            <p className="font-bold text-lg leading-tight">Escola Rosazul</p>
        ...
        <p className="text-xs opacity-70">© Escola Rosazul · Demonstração Front-end</p>
      </div>

      <div className="flex items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-md">
          <div className="lg:hidden flex items-center justify-center mb-8">
            <img src={logo.url} alt="Escola Rosazul" className="size-16" />
          </div>
